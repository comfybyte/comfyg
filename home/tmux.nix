...

{
  programs.tmux = {
    ...
    set -g status-right "#[fg=#1e2030,bg=#1e2030,nobold,nounderscore,noitalics]#[fg=#ffe8db,bg=#1e2030] #{prefix_highlight} #[fg=#3b4261,bg=#1e2030,nobold,nounderscore,noitalics]#[fg=#ffe8db,bg=#3b4261] %Y-%m-%d  %I:%M %p #[fg=#ffe8db,bg=#3b4261,nobold,nounderscore,noitalics]#[fg=#1b1d2b,bg=#ffe8db,bold] #h "
    ...
    setw -g window-status-current-format "#[fg=#1e2030,bg=#3b4261,nobold,nounderscore,noitalics]#[fg=#ffe8db,bg=#3b4261,bold] #I  #W #F #[fg=#3b4261,bg=#1e2030,nobold,nounderscore,noitalics]"
    '';
  };
}
